...
class Bezie extends Component {
  ...
  onIncreaseXIntervalClick() {
    const disabled = this.props.triplet ? this.props.interval.x === 192 : this.props.interval.x === 128;

    if (!disabled) this.props.increaseXInterval();
  }

  onDecreaseXIntervalClick() {
    const disabled = this.props.triplet ? this.props.interval.x === 1.5 : this.props.interval.x === 1;
      ...
      <div className="bezie">
        <div className="push-bottom">
          ...
          <div className="pull-right">
            <ButtonToolbar>
              ...
              <Button disabled={this.props.bars === MIN_BARS} bsSize="small" onClick={::this.onDecreaseBarsClick}>
                <i className="fa fa-minus" />
              </Button>
              <Button disabled={this.props.bars === MAX_BARS} bsSize="small" onClick={::this.onIncreaseBarsClick}>
                <i className="fa fa-plus" />
              </Button>
              <span className="monospace noselect push-left" style={{ lineHeight: "30px" }}>
                {this.props.bars}
              </span>
            </ButtonToolbar>
          </div>
        ...
        <div className="push-top monospace noselect">
          <div className="pull-left" style={{ lineHeight: "30px" }}>
            <ButtonToolbar>
              <span className="pull-left push-left text-muted version">{version}</span>
          ...
          <div className="pull-right">
            <ButtonToolbar>
              <Button onClick={this.props.toggleSnap} className={this.props.snap ? "active" : ""} bsSize="small">
                Snap
              </Button>
              <Button onClick={this.props.toggleTriplet} className={this.props.triplet ? "active" : ""} bsSize="small">
                Triplet
              </Button>
              <Button
              ...
              <span className="pull-left monospace push-left noselect" style={{ lineHeight: "30px" }}>
                1/{this.props.triplet ? this.props.interval.x / 1.5 : this.props.interval.x}
                {this.props.triplet && "T"}
              </span>
            </ButtonToolbar>
          </div>
        </div>
